                ...
                <div class="Article">
                    <div class="container">
                        <article id="main-grid">
                            ...
                            <img class="main-image" src=${main.img_src} alt=${main.title}></img>
                        </article>
                        <div id="list-grid">
                            <div class="List">
                                <div class="list-subgrid">
                                <img class="list-image" src=${list1.img_src} alt=${list1.title}></img>
                                <h3>${list1.title}</h3>
                            ...
                            <div class="List">
                                <div class="list-subgrid">
                                <img class="list-image" src=${list2.img_src} alt=${list2.title}></img>
                                <h3>${list2.title}</h3>
                            ...
                            <div class="List">
                                <div class="list-subgrid">
                                <img class="list-image" src=${list3.img_src} alt=${list3.title}></img>
                                <h3>${list3.title}</h3>
                            ...
                            <div class="List">
                                <div class="list-subgrid">
                                <img class="list-image" src=${list4.img_src} alt=${list4.title}></img>
                                <h3>${list4.title}</h3>
                            ...
                            <div class="List">
                                <div id="list-subgrid">
                                <img class="list-image" src=${list5.img_src} alt=${list5.title}></img>
                                <h3>${list5.title}</h3>
